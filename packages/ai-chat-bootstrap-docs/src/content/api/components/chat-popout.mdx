...
A popout chat interface that wraps ChatContainer. Requires the `useAIChat` hook. Supports overlay or inline panel modes, left/right positioning, and resizable width.
