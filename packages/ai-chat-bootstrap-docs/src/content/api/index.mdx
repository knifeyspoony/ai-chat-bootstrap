...
- **[Message Normalization](/api/utils/message-normalization)** – Ensure messages have valid metadata and timestamps with `ensureMessageMetadata` and `normalizeMessagesMetadata`
- **[Threading & Persistence](/api/utils/threading)** – Types and utilities for implementing custom thread persistence backends
