...
- Next.js route that implements this exact setup: [packages/ai-chat-bootstrap-demo/src/app/basic/page.tsx](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/basic/page.tsx)
- Streaming chat handler used by the demo routes: [packages/ai-chat-bootstrap-demo/src/app/api/chat/route.ts](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/api/chat/route.ts)
