...
The <API name="ChatPopout" /> component provides a complete assistant UI that manages its own input/messages state using <API name="useAIChat" />. It supports overlay and inline modes, left/right positioning, and a draggable resize handle.
