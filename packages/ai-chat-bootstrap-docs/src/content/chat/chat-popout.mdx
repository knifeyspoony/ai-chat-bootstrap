...
- Landing page popout that switches between overlay and inline modes: [packages/ai-chat-bootstrap-demo/src/app/page.tsx](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/page.tsx)
- Command-driven mode switcher wired into the popout: [packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts)
