...
- Frontend tool registrations used across the demo: [packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts)
- Counter widget + tool interactions rendered on the landing page: [packages/ai-chat-bootstrap-demo/src/app/page.tsx](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/page.tsx)
- Shared streaming handler that receives the tools payload: [packages/ai-chat-bootstrap-demo/src/app/api/chat/route.ts](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/api/chat/route.ts)
...
Continue to [Tool Result Rendering →](/features/tool-result-rendering)
