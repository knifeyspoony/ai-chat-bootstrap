  ...
  return (
    <div className="space-y-4">
      ...
      <ChatContainer
        ...
        messages={{
          systemPrompt:
            "You are a helpful assistant with access to the user's profile and settings.",
        }}
        header={{
...
- Shared context wiring for the counter, calculations, and system prompt selector: [packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts)
- Landing page that consumes the hook and lets users toggle focus/context state: [packages/ai-chat-bootstrap-demo/src/app/page.tsx](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/page.tsx)
...
Continue to [Focus Items →](/features/focus-items)
