...
- Centralized command registration (AI + UI) used by the landing page: [packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/hooks/use-demo-ai.ts)
- Popout command palette and toolbar entry points that surface the commands: [packages/ai-chat-bootstrap-demo/src/app/page.tsx](https://github.com/knifeyspoony/ai-chat-bootstrap/blob/main/packages/ai-chat-bootstrap-demo/src/app/page.tsx)
