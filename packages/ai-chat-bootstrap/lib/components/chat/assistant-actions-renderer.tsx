...
import type { AssistantAction, AssistantActionsConfig } from "../../types/actions";
 ...
 */
export const AssistantActionsRenderer = React.memo(function AssistantActionsRenderer({
  message,
  actionsConfig,
