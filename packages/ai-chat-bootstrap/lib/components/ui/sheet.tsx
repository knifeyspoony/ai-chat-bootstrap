...
import { useSheetPortalContainer } from "./sheet-context"
...
function SheetPortal({
  ...
  const contextContainer = useSheetPortalContainer();
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "top" &&
            "data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top inset-x-0 top-0 max-h-full border-b",
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 max-h-full border-t",
          className
        )}
        {...props}
      >
