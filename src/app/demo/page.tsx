...
export default function DemoPage() {
  ...
  return (
    <div className={cn("min-h-screen bg-background", chatMode === 'inline' ? "flex h-screen" : "")}>
      <div className={cn(chatMode === 'inline' ? "px-4 py-12 flex-1 overflow-auto" : "container mx-auto px-4 py-12 max-w-7xl")}>
        {/* Hero Section */}
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <div className="font-medium mb-2 text-primary">Counter Actions:</div>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• "Increment counter by 10"</li>
                  <li>• "Set counter to 50"</li>
                </ul>
              </div>
              <div>
                <div className="font-medium mb-2 text-primary">Math Operations:</div>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• "Calculate 25 * 4"</li>
                  <li>• "What's 144 ÷ 12?"</li>
                  <li>• "Add counter to 100"</li>
                </ul>
              </div>
              <div>
                <div className="font-medium mb-2 text-primary">Focus Control:</div>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Click any card to focus/unfocus it</li>
                  <li>• "Show me what's focused"</li>
